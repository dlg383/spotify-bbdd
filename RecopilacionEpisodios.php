...
<body>
  ...
  session_start();
    ...
    echo "<p style='font-size:30px; '><b>Recopilacion de Episodios</b></p>";
    echo "<p style='font-size:20px; '><b>". $nombre ."</b></p>";

    $episodios = "SELECT *,epi.descripcion as descripcionepisodio FROM episodio as epi INNER JOIN recopilacion_episodios_tiene_episodio as reco INNER JOIN podcast as pod WHERE
    reco.id_recopilacion_episodios='$idrecopilacion'
    and epi.id_episodio = reco.id_episodio and epi.id_podcast = pod.id_podcast";
