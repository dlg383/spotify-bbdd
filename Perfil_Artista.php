...
<body>
  ...
  $artista = "SELECT * FROM artista WHERE id_artistas='$idartistas'";
    ...
    echo "<p><b> Ingresos Actuales </b></p>";
		$ingresos = "SELECT * FROM ingresos_artista WHERE id_artista='$idartistas'";
  ...
  $seguidores = "SELECT * FROM usuario as usu INNER JOIN usuario_sigue_artista as seg ON usu.id_usuario = seg.id_usuario WHERE seg.id_artistas = '$idartistas'";
